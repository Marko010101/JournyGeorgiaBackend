...
},{"axios":"../../node_modules/axios/index.js","./alert.js":"alert.js"}],"maplibre.js":[function(require,module,exports) {
"use strict";
...
var displayMap = exports.displayMap = function displayMap(locations) {
  ...
  var map = new maplibregl.Map({
    ...
    center: locations[0].coordinates // Initial center
    // scrollZoom: false,
    // zoom: 6,
  });
  ...
  locations.forEach(function (location) {
    ...
    new maplibregl.Marker(el).setLngLat(location.coordinates).setPopup(new maplibregl.Popup({
      offset: 25
    }).setMaxWidth("25rem").setHTML("<div class='maplibregl-popup-content'><h4>".concat(location.description, "</h4><p>Day: ").concat(location.day, "</p></div>"))).addTo(map);
    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        ...
        case 8:
          _context.prev = 8;
          _context.t0 = _context["catch"](0);
          (0, _alert.showAlert)("error", ((_error$response = _context.t0.response) === null || _error$response === void 0 || (_error$response = _error$response.data) === null || _error$response === void 0 ? void 0 : _error$response.message) || "Something went wrong!");
        case 11:
        case "end":
          return _context.stop();
      }
...
var _maplibre = require("./maplibre.js");
...
if (mapLibre) {
  var locations = JSON.parse(mapLibre.dataset.locations, (0, _maplibre.displayMap)(locations));
}
